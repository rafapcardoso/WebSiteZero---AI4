...
class Logged_Menu{
    ...
    function __construct(){
	    ...
	    $this->menuRoles = $this->WebService->getRoles();
	    //var_dump($this->menuRoles);
	}
	...
	public function getView(){
		...
		$template = 'Menu_Adm_Full.html';

		//MENU CONTENT
		//Add Help Menu
				$submenu = new MenuStructure();
				$submenu->nome = "Exibir/Ocultar Ajuda";
				$submenu->id = 'helpclass';
			$menu2 = new MenuStructure();
			$menu2->nome = "Ajuda";
			$menu2->submenu = array($submenu);
		array_push($this->menuArray, $menu2);
